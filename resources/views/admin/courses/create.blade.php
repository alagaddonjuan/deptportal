                    ...
                    <form method="POST" action="{{ route('admin.courses.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="level" class="block mt-1 w-full" type="text" name="level" :value="old('level')" placeholder="e.g., Undergraduate, Postgraduate" />
                            </div>

                            <!-- Duration -->
                            <div>
                                <x-input-label for="duration_years" :value="__('Duration (Years)')" />
                                <x-text-input id="duration_years" class="block mt-1 w-full" type="number" name="duration_years" :value="old('duration_years')" />
                            </div>
