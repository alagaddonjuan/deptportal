                    ...
                    <form method="POST" action="{{ route('admin.courses.update', $course) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input id="name" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" type="text" name="name" value="{{ old('name', $course->name) }}" required autofocus />
                            </div>

                            <!-- Course Code -->
                            <div>
                                <label for="code" class="block font-medium text-sm text-gray-700 dark:text-gray-300">{{ __('Course Code') }}</label>
                                <input id="code" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" type="text" name="code" value="{{ old('code', $course->code) }}" required />
                            </div>

                            <!-- Level -->
                            <div>
                                <label for="level" class="block font-medium text-sm text-gray-700 dark:text-gray-300">{{ __('Level') }}</label>
                                <input id="level" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" type="text" name="level" value="{{ old('level', $course->level) }}" />
                            </div>

                            <!-- Duration -->
                            <div>
                                <label for="duration_years" class="block font-medium text-sm text-gray-700 dark:text-gray-300">{{ __('Duration (Years)') }}</label>
                                <input id="duration_years" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" type="number" name="duration_years" value="{{ old('duration_years', $course->duration_years) }}" />
                            </div>
