<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="pt-4 pb-1 border-t border-gray-200">
        <div class="px-4">
            <div class="font-medium text-base text-gray-800">{{ __('Teacher Menu') }}</div>
        </div>

        <div class="mt-3 space-y-1">
            <x-nav-link :href="route('teacher.timetable.index')" :active="request()->routeIs('teacher.timetable.index')">
                {{ __('My Timetable') }}
            </x-nav-link>
            <x-nav-link :href="route('teacher.index')" :active="request()->routeIs('teacher.index', 'teacher.attendance.*')">
                {{ __('Teacher Tools') }}
            </x-nav-link>
        </div>
    </div>
...
<x-nav-link :href="route('admin.timetable.index')" :active="request()->routeIs('admin.timetable.index')">
