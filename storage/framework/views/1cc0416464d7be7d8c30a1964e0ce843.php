                                        ...
                                        <div class="p-4 border dark:border-gray-700 rounded-lg">
                                            <div class="flex justify-between items-center">
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($schedule->teacher->name ?? 'N/A'); ?></p>
                                                </div>
                ...
                <div>
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <?php if($recentGrades->isNotEmpty()): ?>
                                <ul class="mt-4 space-y-3">
                                    <?php $__currentLoopData = $recentGrades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="flex justify-between items-center">
                                            <div>
                                                <p class="font-semibold"><?php echo e($grade->assessment->subject->name); ?></p>
                                                <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($grade->assessment->title); ?></p>
                                            </div>
                                            <p class="font-semibold"><?php echo e($grade->marks_obtained); ?> / <?php echo e($grade->assessment->max_marks); ?></p>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\school-portal-backend\resources\views/student/dashboard.blade.php ENDPATH**/ ?>